...
public class RepeaterSpeechlet implements Speechlet {
    private static final Logger log = LoggerFactory.getLogger(RepeaterSpeechlet.class);
    ...
    public SpeechletResponse onIntent(final IntentRequest request, final Session session)
        ...
        if ("RepeaterIntent".equals(intentName)) {
            return getRepeaterResponse(intent.getSlot("RepeatText").getValue());
    ...
    private SpeechletResponse getHelpResponse() {
        String speechText =
                "This is where I would help you if it was needed.";
